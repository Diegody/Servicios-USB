...
import 'package:servicios/screens/estudiante/icetexE2.dart';
...
class IcetexEScreenE extends StatefulWidget {
  @override
  _IcetexEScreenEState createState() => _IcetexEScreenEState();
}

class OpcionesSeleccionadas {
...
class _IcetexEScreenEState extends State<IcetexEScreenE> {
  ...
  Future<List<Map<String, dynamic>>> getOpcLevel() async {
    final response = await http.post(
      Uri.parse(
          'https://academia.usbbog.edu.co/centralizacion_servicios_ios/API/ICETEX/OpcionNivelAcademico.php'),
    );
  ...
  Future<List<Map<String, dynamic>>> getOpcPrograma(String programa) async {
    final response = await http.post(
        Uri.parse(
            'https://academia.usbbog.edu.co/centralizacion_servicios_ios/API/ICETEX/OpcionProgramaAcademico.php'),
  ...
  Future<List<Map<String, dynamic>>> getOpcCiclo() async {
    final response = await http.post(
      Uri.parse(
          'https://academia.usbbog.edu.co/centralizacion_servicios_ios/API/ICETEX/CicloAcademico.php'),
    );
